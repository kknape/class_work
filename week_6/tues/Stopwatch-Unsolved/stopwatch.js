...
var clockRunning = false; //use this boolean to determine if clock is already running before the interval functions run
var time = 0;
var lap = 1;
...
function start() {
  ...
  if (!clockRunning) { //if clock isnt already running, then run this funciton
